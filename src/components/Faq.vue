<template>
  <div class="col-12">
    <div class="container col-md-8 col-sm-12 mx-auto">
      <h3><b>FAQ</b></h3>
      <div class="row">
  ...
  data() {
    return {
      questions: [
        ...
        ["Do I need to code something to win?", "Nope! This hackathon encourages all types of solutions, including mockups, videos, and proposals for policy changes, in addition to technical solutions."],
        ["Do we follow a Code of Conduct?", "Yes, EnergyHacks follows the <a href='https://static.mlh.io/docs/mlh-code-of-conduct.pdf' target='_blank'>MLH Code of Conduct</a>."]
      ]
    }
  }
});
